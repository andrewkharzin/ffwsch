...
//         }))
//       }
//       // console.log('Customers:', data.map(service => service.servicetype));
//     } catch (fetchError) {
...
//           if (eventType === 'INSERT') {
//             services.value.push(newService as ServiceWithRelations)
...
//                 ...services.value[index],
//                 ...newService,
//                 type_name: newService.servicetype?.type_name || services.value[index].type_name,
//                 full_name: newService.customers?.full_name || services.value[index].full_name,
//                 id: newService.customers?.id || services.value[index].id, // Update company_id
//                 status: newService.servicestatuses?.status || services.value[index].status,
//                 serial_number: newService.service_orders?.serial_number || services.value[index].serial_number
//               }
